#!/usr/bin/env node
const sqlite3 = require('/home/jinghao/.openclaw/workspace/skills/hindsight-memory-skill/node_modules/sqlite3').verbose();
const fs = require('fs');
const path = require('path');

const BASE = process.env.MEMORY_BASE || '/home/jinghao/.openclaw/agents/main';
